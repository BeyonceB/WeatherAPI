This Web App includes the current days weather forcast. It showcases the location, weather description, temperature, what the termperature feels like and the wind gust meter/ seconds.
